...
<body>
	...
	<div>
		<form class="Registro">
			...
			Autor o Autores (en caso de ser varios separelos con una coma) * <input type="text" name="autor" >
			Edicion* <input  type="text" name="edicin" >
			Editorial* <input type="text" name="editoral" >
