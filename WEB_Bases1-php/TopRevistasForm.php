...
<body>
	<header id="site_head"><!--useful to create the 960px limit-->
		...
		<ul>
			...
			<li><a href="PagRevistas.php">Volver</a></li>
		</ul>
		</nav>
		</div>
	</header>
	...
	<div>
		<form class="Top" action="topNormalRevistas.php" method="POST">
	...
	<div>
		<form class="TopMeses" action="topNormalRevistas.php" method="POST">
