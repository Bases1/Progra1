...
<body>
	...
	<div id="main_content"><!--useful to create the 960px limit-->
		<nav class="iconos">
		<ul>
			<li class="libros"><a href="Paglibros.php"></a></li>
			<li class="revistas"><a href="PagRevistas.php"></a></li>
			<li class="peliculas"><a href="PagPeliculas.php"></a></li>
			<li class="personas"><a href="PagPersonas.php"></a></li>
		</ul>
		</nav>
